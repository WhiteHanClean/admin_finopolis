...
const dataQuestions: Question[] = [
  {
    id: '1',
    question: 'почему быть фронтом круче чем беком?',
    answer: 'React is a JavaScript library for building user interfaces.',
  },
  {
    id: '2',
    question: 'фронты красавчики! итс утверждение',
    answer: 'A Hook is a special function that lets you “hook into” React features.',
  },
  {
    id: '3',
    question: 'шо там по дедлайнам?',
...
const Cell = ({ row }) => {
  ...
  const handleDelete = () => {
    // Добавьте логику для удаления вопроса
    // console.log(`Deleting question with ID: ${question.id}`)
    setIsDeleteDrawerOpen(false)
  }

  const handleSaveAnswer = () => {
    // Добавьте логику для сохранения ответа
